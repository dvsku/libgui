...
namespace libgui::ex::imgui::internals {
    class imgui_backend_context_glfw_opengl2
        : public imgui_backend_context,
          public libgui::internals::backend_context_glfw_opengl2
    {
    public:
        imgui_backend_context_glfw_opengl2(libgui::window_base* wnd, libgui::internals::window_base* wnd_internal);
